...
class FieldOption(PeopleModel): ENDPOINT_NAME='field_data'
class Household(PeopleModel): ENDPOINT_NAME='households'
class HouseholdMembership(PeopleModel): ENDPOINT_NAME='households'
...
class Note(PeopleModel): ENDPOINT_NAME='notes'
...
class PhoneNumber(PeopleModel): ENDPOINT_NAME='people'
